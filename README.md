...
Women Safety App is a simple Android application developed as a student project to provide quick emergency assistance during unsafe situations.

## ✨ Features

- 📳 **Shake Detection** – Shake the phone 3 times to trigger an SOS alert.
